...
setup(
    name = 'airflow_parser',         # How you named your package folder (MyLib)
    packages = ['airflow_parser', 'airflow_parser.providers'],   # Chose the same as "name"
    ...
    url = 'https://github.com/dillonjohnson/airflow_parser',   # Provide either the link to your github or to your website
